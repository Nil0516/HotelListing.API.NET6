...
builder.Services.AddSingleton<IAuthProvider>(x => new AuthProvider(connectionString));
...
static Task WriterResponse(HttpContext context, HealthReport healthReport)
{
